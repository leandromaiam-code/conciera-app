        ...
        <div className="space-y-6 py-4">
            ...
            <div className="space-y-6">
              <div className="text-center space-y-2">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  1. Abra o <strong>WhatsApp</strong> no seu celular
                  <br />
              ...
              <div className="bg-esmeralda/10 border border-esmeralda/30 rounded-lg p-4">
                <div className="flex items-center justify-center gap-2">
                  <span className="text-sm text-muted-foreground">Código expira em:</span>
          ...
          {qrCode && timeLeft === 0 && !isConnected && (
            <div className="text-center space-y-4">
              ...
              <div>
                <h3 className="text-lg font-semibold mb-2">QR Code Expirado</h3>
                <p className="text-sm text-muted-foreground">O código expirou. Por favor, gere um novo QR Code.</p>
              </div>
              <Button
                onClick={() => {
                  setQrCode("");
          ...
          {isConnected && (
            <div className="text-center space-y-4 py-6">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Seu WhatsApp foi conectado e está pronto para uso.</p>
              </div>
            </div>
          )}
        </div>
